...
const sharedEnv = {
  ...
  AZURE_AI_ENDPOINT: prodEnv.AZURE_AI_ENDPOINT,
  AZURE_AI_API_KEY: prodEnv.AZURE_AI_API_KEY,
  AZURE_AI_DEPLOYMENT: prodEnv.AZURE_AI_DEPLOYMENT || 'Phi-4-mini-instruct',
