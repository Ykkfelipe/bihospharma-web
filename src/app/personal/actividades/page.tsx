    ...
    return (
        <PortalShell title="Seguimiento de actividades">
            <div className="portal-page portal-animate-in">
                ...
                <div className="portal-section-card portal-section-card--padded" style={{ marginBottom: 24 }}>
                    <div className="portal-section-header">
                        ...
                        <h2 className="portal-section-card-title">Registrar actividades</h2>
                    </div>
                    <form onSubmit={handleSubmit}>
                        <label htmlFor="activity-summary" className="portal-form-label">
                            ¿Qué actividades realizó hoy?
                        </label>
                        <textarea
                            id="activity-summary"
                            className="portal-input portal-form-textarea"
                            value={summary}
                ...
                <div className="portal-section-card portal-section-card--padded">
                    <div className="portal-section-header">
                        ...
                        <h2 className="portal-section-card-title">Registros de hoy</h2>
                    </div>
                    {loading ? (
                        <p className="portal-empty-hint">Cargando…</p>
                    ) : logs.length === 0 ? (
                        <p className="portal-empty-hint">Aún no ha registrado actividades hoy.</p>
                    ) : (
                        <ul className="portal-activity-logs">
                            {logs.map((log) => (
                                <li key={log.id} className="portal-activity-log-item">
                                    <p className="portal-activity-log-text">{log.summary}</p>
                                    <p className="portal-activity-log-meta">
