...
export function EarlyReasonModal() {
    ...
    const submit = async () => {
        ...
        setSaving(true);
        try {
            const res = await fetch("/api/attendance/early-reason", {
                method: "POST",
    ...
    return (
        <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="early-reason-title"
            style={{
                position: "fixed",
                inset: 0,
                zIndex: 9999,
        ...
        >
            ...
            >
                ...
                <div style={{ padding: "20px 24px 24px" }}>
                    ...
                    <textarea
                        id="early-reason-text"
                        value={reason}
                        onChange={(e) => setReason(e.target.value)}
                        rows={4}
                        maxLength={500}
                        placeholder="Ej.: Cita médica, permiso autorizado, diligencia personal..."
                        style={{
                            width: "100%",
