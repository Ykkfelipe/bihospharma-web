...
const nextConfig = {
  ...
  // Next.js redimensiona y sirve AVIF/WebP según el navegador y el atributo sizes.
  // Requiere que el servidor de producción pueda servir /_next/image (server.js lo soporta).
  images: {
    unoptimized: false,
